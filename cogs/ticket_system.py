...
TEAM_ROLE1 = config["team_role_id_1"] #Admin Team role id
TEAM_ROLE2 = config["team_role_id_2"] #Mod Team role id
TEAM_ROLE3 = config["team_role_id_3"] #Trial Mod Team role id
    ...
    @discord.ui.select(
        ...
        options=[
            ...
            discord.SelectOption(
                ...
                emoji="<:Purple_Star:1156402258133651537>",        #Emoji of the 2 Option  if you want a Custom Emoji read this  https://github.com/Simoneeeeeeee/Discord-Select-Menu-Ticket-Bot/tree/main#how-to-use-custom-emojis-from-your-discors-server-in-the-select-menu
        ...
        if select.values[0] == "support1":
            if interaction.channel.id == TICKET_CHANNEL:
                ...
                if existing_ticket is None:
                    ...
                    embed = discord.Embed(title=f"· · · · · ・˚₊⋆✦ ・Contact Staff ・ ✦⋆₊˚・ · · · · · ·",
                               color=0xc7ccea,
                    ...
                    embed.set_image(url='https://media.discordapp.net/attachments/1155577204571373658/1156334776664461484/IMG_4105.png?ex=651540ee&is=6513ef6e&hm=351b326f1d1323fb51b6501914278745670c62f04c608073acd5b5592c59628a&=&width=1920&height=172')
